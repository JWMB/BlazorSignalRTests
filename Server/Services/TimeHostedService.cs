namespace BlazorWebAssemblySignalRApp.Server.Services
{
    ...
    public class TimedHostedService : BackgroundService
    {
        ...
        public TimedHostedService(Func<CancellationToken, Task> workFunction, //IServiceProvider services,
    ...
    public class TimedHostedServiceX : IHostedService, IDisposable
    {
        private int executionCount = 0;
        private readonly Func<Task> workFunction;
        private readonly ILogger<TimedHostedServiceX> logger;
        private Timer? timer = null;
        private CancellationToken? cancellationToken;

        public TimedHostedServiceX(Func<Task> workFunction, ILogger<TimedHostedServiceX> logger)
        {
            this.workFunction = workFunction;
            this.logger = logger;
        }
